...
const STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  INGESTED:            { label: "Ingested",        className: "status-ingesting" },
  EXTRACTING:          { label: "Extracting",      className: "status-extracting" },
  EXTRACTING_COMPLETE: { label: "Extracted",       className: "status-extracting" },
  SCORING:             { label: "Scoring",         className: "status-scoring" },
  SCORING_COMPLETE:    { label: "Scored",          className: "status-scoring" },
  REDLINING:           { label: "Redlining",       className: "status-scoring" },
  REDLINING_COMPLETE:  { label: "Redlined",        className: "status-scoring" },
